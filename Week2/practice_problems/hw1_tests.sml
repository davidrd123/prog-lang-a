...
val feb2000 = (2000,2,1)
val feb2020 = (2020,2,1)
val dec2010 = (2010,12,1)
...
val date_to_string_test01 = date_to_string((2000,1,1)) = "January-1-2000"
val date_to_string_test02 = date_to_string((2010,3,20)) = "March-20-2010"
val date_to_string_test03 = date_to_string((2012,12,12)) = "December-12-2012"
...
val oldest_test01 = oldest([(2012,2,28),(2011,3,31),(2011,4,28)]) = SOME (2011,3,31)
val oldest_test02 = oldest([(2010,2,1)]) = SOME (2010,2,1)
val oldest_test03 = oldest([]) = NONE
val oldest_test04 = oldest([(1979,7,5),(1985,2,4),(1945,6,11)]) = SOME (1945,6,11)
